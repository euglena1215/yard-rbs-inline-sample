...
module YARD
  module Templates::Helpers
    ...
    module MethodHelper
      # @rbs return: String -- formatted arguments for a method
      ...
      # @rbs return: String -- formatted and linked return types for a method
      ...
      # @rbs return: String -- formatted block if one exists
      ...
      # @rbs return: String -- formats line numbers for source code of an object
      ...
      # @rbs return: String -- formats source of an object
      ...
      # @rbs return: String -- formats source code of a constant value
