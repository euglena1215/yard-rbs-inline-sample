  ...
  module Templates
    ...
    module Engine
      class << self
        ...
        #
        # @rbs path: String -- a new template path
        # @rbs return: void
        ...
        #
        # @rbs path: String -- the path name of the template
        # @rbs full_paths: Array[String] -- the full path on disk of the template
        # @rbs return: Template -- the template module representing the +path+
        ...
        # @rbs objects: Array[CodeObjects::Base] -- a list of {CodeObjects::Base}
        # @rbs options: Hash[untyped, untyped] -- (see {render})
        # @rbs return: void
        ...
        # @rbs from_template: Template -- if provided, allows a relative
        # @rbs path: String -- the path component to search for in the
        # @rbs return: Array[String] -- a list of full paths that are existing
        ...
        #
        # @rbs path: String -- the path to generate a module name for
        # @rbs return: String -- the module name
